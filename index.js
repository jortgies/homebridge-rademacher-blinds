                ...
                if (body.devices)
                {
                    body.devices.filter(data => did_filter(self.log,config,data)).forEach(function(data) {
                        ...
                        if(["27601565","35000864","14234511","35000662","36500172","36500572_A","16234511_A","16234511_S","45059071","31500162","23602075","32000064","32000064_A","14236011",
                            "23782076","10182345","10502002","10122345","35200262","10236020","10941001","10251530","10142345","16901001"].includes(data.deviceNumber))
                        {
                        ...
                        // lock/switch
                        else if(["35000262","35001164","32501972","32501972_A","99999960","11301001"].includes(data.deviceNumber))
                        {
